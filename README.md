1. Задать значение атрибута action у формы myForm
2. Запустить веб-сервер, например, находясь в корне выполнить комманду python -m SimpleHTTPServer 8000, после чего открыть страницу по адресу http://localhost:8000 
